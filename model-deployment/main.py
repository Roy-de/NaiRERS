...
async def get_neighbours(input_data: InputData):
    try:
        ...
        # return {f"Distance from the single point to Cluster {i}": f"{distance:.2f} kilometers" for i, distance in
        # enumerate(distances_to_clusters)} Return distances as a list of strings
